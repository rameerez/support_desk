...
# A migrated COPY of create_support_desk_tables.rb.erb with the migration version
# pinned. Keep the two IN SYNC: regenerate with the script in the git log
# for this file whenever the template changes.

class CreateSupportDeskTables < ActiveRecord::Migration[7.2]
  def change
